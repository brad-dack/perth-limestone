      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Jobs outside the metro area can still be sent through, but there is just no guarantee anyone covers that far out."
          ]
        }
      ]
    },
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            { table: {
              head: ["Local Government", "Front fence height limit", "Permeability requirement", "Truncation / sightline", "Council page", "Last checked"],
              rows: [
                ["City of Bayswater", "Generally front fences are permitted to be solid up to a maximum height of 1.2m when measured from street level.", "Approximately 50% visually permeable up to a maximum height of 1.8m when measured from street level.", "Fences adjacent to vehicle access points (where driveways meet the street) or intersecting street corners must maintain clear driver visibility lines.", "[Fences and retaining walls](https://www.bayswater.wa.gov.au/home-and-property/renovating-your-home-or-property/fences-and-retaining-walls)", "2026-07-28"],
                ["City of Belmont", "1800mm in height.", "Permeable above 1200mm in height.", "Not exceeding 750mm in height where located within 1500mm of where a driveway intersects a street frontage boundary.", "[Front fence](https://www.belmont.wa.gov.au/build/demolishing-and-building/approval-for-buildings-and-structures/i-want-to-build/front-fence)", "2026-07-28"],
                ["City of Canning", "Fences within the primary street setback area must not exceed 1.2m in height.", "Solid lower sections are generally restricted to 1.2m; any height extending above that (up to 1.8m) must be visually permeable infill.", "Fences must be truncated or reduced to a maximum of 0.75m within a 1.5m splay where a driveway meets a public street, or where two streets/rights-of-way intersect on a corner lot.", "[Local planning policy (PDF)](https://www.parliament.wa.gov.au/publications/tabledpapers.nsf/displaypaper/4110516cb083ce9958bdd4bf4825874a0004a1a1/$file/tp-516.pdf)", "2026-07-28"],
                ["City of Fremantle", "Fences within the primary street setback area can go up to 1.8m, with decorative piers allowed up to 2.0m.", "Above the solid lower threshold (1.2m standard, lower in some heritage areas), the fence must be at least 50% visually permeable up to the 1.8m maximum.", "Fences adjacent to a driveway, vehicle access point or street corner must provide a 1.5m x 1.5m visual truncation or drop to a maximum of 0.75m above natural ground level.", "[Local Planning Policy 2.8 - Fences (PDF)](https://www.fremantle.wa.gov.au/wp-content/uploads/2025/09/Local-Planning-Policy-2.8-Fences.pdf)", "2026-07-28"],
                ["City of Melville", "Any fence taller than 1.8m total, or a masonry front fence (limestone, brick or similar) higher than 0.75m, requires formal local government or building approval.", "Any portion between 1.2m and 1.8m high must be visually permeable.", "Fences must drop to a maximum of 0.75m within 1.5m of where a driveway meets the property boundary or street.", "[Building a fence or retaining wall](https://www.melvillecity.com.au/planning-and-building/building-or-renovating/building-a-fence-or-retaining-wall)", "2026-07-28"],
                ["City of Nedlands", "Maximum of 1.2m above natural ground level without requiring approval.", "Up to 1.8m is permitted provided any height above 1.2m is visually permeable.", "A 1.5m x 1.5m corner truncation is required where driveways meet footpaths and at street-intersection corner lots.", "[Gazetted planning policy (PDF)](https://www.legislation.wa.gov.au/legislation/prod/gazettestore.nsf/FileURL/gg2008_025.pdf/$FILE/Gg2008_025.pdf?OpenElement)", "2026-07-28"],
                ["City of Perth", "Maximum 1.2m solid construction above the adjacent pavement or natural ground level without requiring special planning/building approval.", "Any section built higher than 1.2m must be visually permeable, with upper infill achieving 75-80% openness depending on precinct guidelines.", "Where a driveway meets a public street, fences must be truncated or reduced to a maximum of 0.75m within a 1.5m splay.", "[Perimeter Fencing Policy (PDF)](https://perth.wa.gov.au/-/media/Project/COP/COP/COP/Documents-and-Forms/Develop/Documents/Planning-Framework/Subiaco-Planning-Policies/2-5-Perimeter-Fencing-Policy.pdf)", "2026-07-28"],
                ["City of South Perth", "Solid front fences, walls or pillar piers up to 1.2m high from natural ground/verge level.", "Below 1.2m the fence can be fully solid; between 1.2m and 1.8m the portion above 1.2m must be visually permeable.", "Fences, walls and landscaping must be reduced to 0.75m (highly permeable) within a 1.5m splay where a driveway meets a public street.", "[Local planning policies](https://southperth.wa.gov.au/development/planning/local-planning-policies)", "2026-07-28"],
                ["City of Stirling", "Solid parts of a front fence or wall can be built up to 1.2m high from natural ground level.", "Total fence height can reach 1.8m without planning approval; anything above 1.2m (up to 1.8m) must be visually permeable.", "Fences near a driveway/street intersection are typically restricted to 0.75m within a 1.5m sightline triangle unless fully permeable.", "[Street walls and fences information](https://www.stirling.wa.gov.au/city-and-council/document-and-publications/street-walls-and-fences-information)", "2026-07-28"],
                ["City of Subiaco", "Maximum 0.9m solid from natural ground level; any front fence or solid portion exceeding 0.9m (or 1.2m in some precincts/heritage areas) requires approval.", "Any part higher than 0.9m from natural ground level must be visually permeable.", "Fences must be truncated to 0.75m within 1.5m of a driveway/public street, or within a 3m radius where two public streets intersect.", "[Residential development policy (PDF)](https://www.subiaco.wa.gov.au/media/cakdhcyb/1-1-residential-development-single-houses-and-grouped-dwellings.pdf)", "2026-07-28"],
                ["City of Vincent", "Any solid wall higher than 1.2m, or any overall fence structure exceeding 1.8m, requires approval.", "The fence must be visually permeable above 1.2m, with a minimum of 50% continuous gaps (generally 40-50mm).", "Where a fence is higher than 0.75m, a 1.5m x 1.5m visual truncation is required on each side of a driveway crossover.", "[Front fence information sheet (PDF)](https://www.vincent.wa.gov.au/Profiles/vincent/Assets/ClientData/Planning_Information_Sheets/Planning_Information_Sheet_-_Front_Fence_-__August_2022_.pdf)", "2026-07-28"],
                ["Shire of Peppermint Grove", "Approval required for front fences or pillars exceeding a solid 900mm limit, or for solid alternatives up to 1.8-2.1m on merit.", "Any part of the front boundary fence higher than 900mm must use an open-aspect design (open timber, wrought iron, steel or aluminium palings).", "Fences adjacent to driveways/crossovers must maintain clear visibility triangles, typically restricting solid elements above 750-900mm within safety splay zones.", "[Fencing](https://www.peppermintgrove.wa.gov.au/development/building/fencing.aspx)", "2026-07-28"],
                ["Town of Bassendean", "Up to 1.8m from natural ground level (or the base of a supporting retaining wall) can meet deemed-to-comply criteria, subject to permeability rules.", "Must be visually permeable above 1.2m from natural ground level; the lower 1.2m can be solid.", "Must not exceed 750mm within 1.5m of a driveway intersecting a public street or right-of-way, or at intersecting streets/corner lots.", "[Building or altering a fence (PDF)](https://www.bassendean.wa.gov.au/Profiles/bassendean/Assets/ClientData/Document-Centre/Building_Services/Information_Sheets/Building_or_Altering_a_Fence__Building_Permit_.pdf)", "2026-07-28"],
                ["Town of Cambridge", "Approval needed for front fences or portions exceeding 0.75m solid or going up to 1.8-2.0m; piers can reach 1.8m at up to 350mm x 350mm.", "Any portion higher than 0.75m must be visually transparent or open style.", "A 1.5m x 1.5m sightline truncation is required where a driveway intersects the street boundary.", "[Streetscape policy (PDF)](https://www.cambridge.wa.gov.au/files/assets/public/documents-and-files/development-amp-sustainability/planning/local-planning-policies/local-planning-policy-3.1-streetscape-amended-august-2021.pdf)", "2026-07-28"],
                ["Town of Claremont", "Free-standing front fences exceeding 1.2m within the primary street setback area require approval.", "Above 1.2m, more than 50% of the fence must be visually permeable.", "Fences flanking a driveway intersecting a public street must reduce to 750mm near the property line/crossover.", "[Front fences policy (PDF)](https://www.claremont.wa.gov.au/media/paxn4lch/local-planning-policy-117-front-fences-v8-2.pdf)", "2026-07-28"],
                ["Town of Cottesloe", "Any freestanding front fence or pillar exceeding 1.2m (or 900mm for certain solid configurations) requires approval.", "Any portion above the solid limit (1.2m, or 900mm where specified) must be visually permeable.", "Fences near driveways/crossovers are typically restricted to 750mm within a visual truncation triangle.", "[Planning FAQs](https://www.cottesloe.wa.gov.au/develop-build/planning/planning-faq.aspx)", "2026-07-28"],
                ["Town of East Fremantle", "Approval is required if any section exceeds 1.8m total, solid portions exceed 1.2m, or the property is in a heritage area; a building permit is needed if masonry exceeds 750mm.", "Any part above 1.2m up to the 1.8m maximum must be at least 60% visually permeable.", "Fences at driveways or street corners must provide safety sightlines.", "[Front fence fact sheet (PDF)](https://www.eastfremantle.wa.gov.au/Profiles/eastfremantle/Assets/ClientData/Fact_Sheet_-_Front_Fence__.pdf)", "2026-07-28"],
                ["Town of Mosman Park", "No local planning policy for front fences was found, so the state default applies: solid construction up to 1.2m above natural ground level.", "Above 1.2m the fence must be visually permeable up to a 1.8m maximum (WA-wide Residential Design Codes default, not Mosman Park-specific).", "Not specified in a Mosman Park document found; check with the Town directly.", "[Residential Design Codes (state default)](https://www.dplh.wa.gov.au/rcodes)", "2026-07-28"],
                ["Town of Victoria Park", "Solid or opaque front fences and masonry walls within the primary street setback area are restricted to 1200mm.", "Above a solid base (typically 600-1200mm), the fence must be at least 50% visually permeable up to 1800-2000mm total.", "Fences adjacent to a driveway must provide a clear 1500mm x 1500mm visibility truncation.", "[Fencing Local Law 2020 (PDF)](https://www.victoriapark.wa.gov.au/council-meetings/agenda-briefing-forum/02-february-2021/767/documents/1-fencing-local-law-2020-final-for-adoption.pdf)", "2026-07-28"],
                ["City of Kalamunda", "Any front fence exceeding 1.2m requires a Development Application and Building Permit.", "Any portion above 1.2m must maintain at least 50% visual permeability.", "Fences must be restricted to 0.75m within 1.5m of where a driveway meets a public street, or where two streets intersect.", "[Local Planning Policy 13 (PDF)](https://www.kalamunda.wa.gov.au/docs/default-source/planningdocs/policies/lpp13.pdf?sfvrsn=9f41569a_14)", "2026-07-28"],
                ["City of Swan", "Maximum total height of 1.8m (up to 2.1m for decorative piers/posts in specific designs).", "Areas above 1.2m must be visually permeable, typically at least 50% open.", "Fences must be truncated to 0.75m within a 1.5m x 1.5m area where a driveway meets a public street, or where two streets intersect.", "[Local Planning Scheme 17, Schedule 5 (PDF)](https://www.swan.wa.gov.au/awcontent/Web/Documents/Planning-Building/local-planning-scheme-17_schedule_5_exempted_development.pdf)", "2026-07-28"],
                ["Shire of Mundaring", "Written consent is needed for any freestanding front fence greater than 1.2m.", "Where approval is granted above 1.2m, the design must generally maintain open or splayed construction.", "Fences either side of a driveway must be splayed or angled 1.5m into the lot, or reduced to 750mm within 1.5m of the driveway/street junction.", "[Fencing local law (PDF)](https://www.mundaring.wa.gov.au/documents/34/fencing-local-law)", "2026-07-28"],
                ["City of Joondalup", "A Development Application is needed if the fence exceeds 1.8m or fails permeability limits; a building permit is required for masonry over 0.75m.", "Any part above 1.2m must be visually permeable.", "Fences must be truncated or reduced to 0.75m within a 1.5m splay where a driveway meets the front boundary.", "[Fencing and street walls](https://www.joondalup.wa.gov.au/plan-and-build/residential-building-and-renovation-guides/fencing-and-street-walls)", "2026-07-28"],
                ["City of Wanneroo", "Solid fences up to 1.2m, or up to 1.8m if the portion above 1.2m is visually permeable.", "Any portion above 1.2m must be at least 50% visually permeable.", "Safety sightlines are mandatory next to driveway access points or on corner lots.", "[Front fence information sheet (PDF)](https://www.wanneroo.wa.gov.au/download/downloads/id/364/front_fence_-_information_sheet.pdf)", "2026-07-28"],
                ["City of Armadale", "Written consent is required if a freestanding front fence exceeds 1.2m within the primary street setback area.", "Any portion above 1.2m above natural ground level must be visually permeable.", "Fences must be truncated or reduced to 750mm within a 1.5m splay.", "[Fencing Local Law 2011 (PDF)](https://assets.ctfassets.net/p4i5hqtl4d48/7BqkwLdYPO3J0v7US6JIWi/a12b3526d3bac2851049f566f5113211/Fencing_Local_Law_2011.pdf)", "2026-07-28"],
                ["City of Gosnells", "Anything higher than 1.2m solid, or higher than 1.8m overall, or masonry over 0.75m needs a building or council permit.", "Any part higher than 1.2m must be visually permeable.", "Fences next to a driveway must provide a clear 1.5m x 1.5m visual truncation, or drop to a maximum of 0.75m.", "[Front and secondary street fencing (PDF)](https://www.gosnells.wa.gov.au/sites/default/files/seamless/front_and_secondary_street_fencing_residential.pdf)", "2026-07-28"],
                ["Shire of Serpentine-Jarrahdale", "Any front fence or wall exceeding 1.2m solid, or rising higher than 1.8m overall, requires a building permit and/or planning approval.", "Above 1.2m, the upper portion must be visually permeable.", "Fencing that abuts a driveway, crossover or street corner must provide a clear view for safety.", "[Front fences](https://www.sjshire.wa.gov.au/planning-and-development/building/building-advice/front-fences.aspx)", "2026-07-28"],
                ["City of Cockburn", "Solid walls higher than 1.2m, overall fences taller than 1.8m, or use of specialty materials, may require approval.", "Any part higher than 1.2m from natural ground level must be visually permeable.", "Must incorporate a 1.5m x 1.5m visual truncation on each side of a driveway if the fence is taller than 750mm.", "[Fences and retaining walls](https://www.cockburn.wa.gov.au/Building-Planning-and-Roads/Applications-and-Permits/fences-and-retaining-walls)", "2026-07-28"],
                ["City of Kwinana", "No council approval or building permit is needed if the fence is 1.2m or lower in the front setback area.", "The portion from 1.2m up to 1.8m high must be visually permeable.", "Solid fences or walls more than 750mm high are restricted within 1.5m of where a driveway meets the street boundary.", "[Fence information sheet (PDF)](https://www.kwinana.wa.gov.au/council/documents,-publications-and-forms/publications-and-forms-(all)/information-sheets-and-guides/2020/fence-information-sheet)", "2026-07-28"],
                ["City of Rockingham", "Max 1.2m for standard residential front setback areas; max 0.9m for RMD (medium density) zoned lots.", "Height above 1.2m (or 900mm in some medium-density policies) generally must be visually permeable, conforming to the Residential Design Codes or local law.", "Fences adjacent to driveways must provide a clear sightline truncation (typically 1.5m x 1.5m, or restricted below 0.75-0.9m).", "[Fencing Local Law 2020 (PDF)](https://rockingham.wa.gov.au/getContentAsset/a432b025-da96-4a53-9b78-b267130b65ab/3ca954ad-3848-47c6-8f97-68cebe0b47a2/Fencing-Local-Law-2020-Gazetted-Version.pdf?language=en)", "2026-07-28"]
              ]
            } },
            { note: "Town of Mosman Park: its fencing local law was under community consultation as part of a 2026 local laws review at the time this was checked, with a council decision expected mid-2026. The state-default figures above may be superseded; re-check before relying on this row." },
